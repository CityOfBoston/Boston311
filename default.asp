<!--This is where all the code happens for /311/default.asp or just /311
	However it's important to note that there are many things being included from /system or master sheets-->
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		...
		<div id="layout">
			<div class="pure-g">
				<div class="pure-u-1" id="header">
					...
					<!-- This is the BOS:311 header on top of content-1 -->
				</div>
				<div class="pure-u-1" id="content-1">
					<!--content-1 is the top bar with 4 icons-->
					<div id="title">
										...
										<div class="Content">
											...
											<div id="COB" class="SubCategory">
												...
												<div>
													<ul>
														<li>
															<a href="http://www.cityofboston.gov/images_documents/Annual%20Live%20Entertainment%20Application%20(1)_tcm3-10001.pdf"
															class="mainColLink">Live Entertainment (Annual 7 Day)</a>
														</li>
														<li>
														...
														<li>
															<a href="http://www.cityofboston.gov/images_documents/FORTUNE%20TELLER%20application%20revised%203-2013_tcm3-18711.pdf"
															class="mainColLink">Fortune Teller</a>
														</li>
														<li>
															<a href="http://www.cityofboston.gov/images_documents/tables%20and%20alleys%20license%20application_full_fillable_tcm3-48082.pdf"
															class="mainColLink">Pool / Billiard Table </a>
														</li>
														<li>
															<a href="http://www.cityofboston.gov/images_documents/tables%20and%20alleys%20license%20application_full_fillable_tcm3-48082.pdf"
															class="mainColLink">Bowling Alley</a>
														</li>
													</ul>
												</div>
												<font class="SubCategoryLabel">
											...
											<div id="Event " class="SubCategory ">
												...
												<div>
													<ul>
														...
														<li>
															<a href="http://www.cityofboston.gov/images_documents/Automatic%20Amusement%20Device%20%26%20Games%20Annual%20Application_tcm3-9996.pdf"
															class="mainColLink ">Automatic Amusement Devices</a>
														</li>
													</ul>
												</div>
											</div>
	...
	<!---- =========================CONTAINER PANEL 10============================ -->
							...
							<div class="toggle_faqcontainer">
								<div class="faq-box">
									<div class="faq-content">
										<div class="Content">
											<h6>311 is an easy-to-remember telephone number that connects you with highly-trained Constituent Service Center representatives
												who are ready to help you with requests for non-emergency City services and information.</h6>
											<br />
										</div>
										<div style="clear:both;"></div>
									</div>
						...
						<div class="expand_wrapper">
							...
							<div class="toggle_faqcontainer">
								<div class="faq-box">
									<div class="faq-content">
										<div class="Content">
											<h6>311 is the number to call to obtain information and access to all non-emergency City services. 911 is the number to call
												in case of emergency (burning house, robbery, crime in progress).</h6>
											<br />
										</div>
										<div style="clear:both;"></div>
									</div>
						...
						<div class="expand_wrapper">
							...
							<div class="toggle_faqcontainer">
								<div class="faq-box">
									<div class="faq-content">
										<div class="Content">
											<h6>If you are a VOIP customer and having difficulty calling 311, it is best to contact your VOIP provider and let them know
												you cannot connect. It is up to individual VOIP providers to make 311 services available to their customers. Once configured,
												VOIP service should work properly as long as you are registered as located within the boundaries of the City of Boston. Alternatively,
						...
						<div class="expand_wrapper">
							...
							<div class="toggle_faqcontainer">
								<div class="faq-box">
									<div class="faq-content">
										<div class="Content">
											<h6>Many offices and institutions have complex routing and telephone systems that may need to be configured to allow users to
												dial 311. You can contact the telecomm office for your company or institution and request they reconfigure the system to
												allow calls to 311. Alternatively, you can access Boston 311 services by dialing 617-635-4500.</h6>
											<br />
										</div>
										<div style="clear:both;"></div>
									</div>
						...
						<div class="expand_wrapper">
							...
							<div class="toggle_faqcontainer">
								<div class="faq-box">
									<div class="faq-content">
										<div class="Content">
											<h6>There are several ways Residents can request city services other than calling 311. Residents are encouraged to download
												the BOS:311 mobile app, Tweet @BOS311, or visit City Hall To Go, Boston's mobile city services truck. To speak with someone
												from the Mayor's Office of Constituent Service in person, please come to the Mayor's Office on the 5th Floor of City Hall
												weekdays between 9 a.m. and 5 p.m.</h6>
											<br />
										</div>
										<div style="clear:both;"></div>
									</div>
									...
									<div class="faq-content">
										<div class="Content">
											<h6>Once you have successfully submitted your request, you will receive an email with a tracking number that you can use to
												...
												<a href="http://mayors24.boston.gov/Ef3/SSP_TrackCase.xml"> You can track your service request here</a>
											</h6>
											<br />
										</div>
										<div style="clear:both;"></div>
		...
		<div class="pure-g" id="footer">
			...
			<div class="pure-u-1-3  pure-md-1-3 pure-lg-1-3"></div>
		...
		<!-- un-minified scripts <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.0/js/select2.js"></script>
			-->
